...
class GPUParticleSystem extends THREE.Object3D {
    constructor(options) {
        ...
        this.geometry.setAttribute('positionStart', new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3));
        this.geometry.setAttribute('velocity',      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3));
        this.geometry.setAttribute('acceleration',  new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3));
        this.geometry.setAttribute('color',         new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3));
        this.geometry.setAttribute('endColor',      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3));

        //scalar attributes
        this.geometry.setAttribute('startTime',     new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1));
        this.geometry.setAttribute('size',          new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1));
        this.geometry.setAttribute('lifeTime',      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1));
